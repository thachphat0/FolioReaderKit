...
public enum FolioReaderFont: Int {
    ...
    public static func folioReaderFont(fontName: String) -> FolioReaderFont? {
        ...
        case "times"        : font = .times
        case "helveticaNeue": font = .helveticaNeue
        case "skolarSansLatin": font = .skolarSansLatin
        default: break
        }
        return font
    }
    ...
    public var cssIdentifier: String {
        ...
        case .skolarSansLatin: return "skolarSansLatin"
        }
    }
}
